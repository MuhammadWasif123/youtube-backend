...
const loginUser = asyncHandler(async (req,res)=>{
    // first we need to take the data from the request body
    // username or email
    // find the user in DB
    // password check
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    if(!avatarLocalPath){
        throw new ApiError(400,"Avatar file is missing on multer")
    }
...
const updateUserCoverImage = asyncHandler(async(req,res)=>{
    ...
    if(!coverImageLocalPath){
        throw new ApiError(400,"Cover image file is missing on multer")
    }
